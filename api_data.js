define({ "api": [
  ...
  },
  {
    ...
    "title": "Create new sub-task comment",
    "version": "0.0.1",
    "group": "create",
    "parameter": {
      "fields": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "subTaskId",
            "description": "<p>subTaskId of the sub task passed as the URL parameter</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "comment_id",
            "description": "<p>comment_id of the subtask comment passed as the URL parameter</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "Delete subtask by taskId and subtask_id",
    "version": "0.0.1",
    "group": "delete",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "subtask_id",
            "description": "<p>subtask_id of the subtask passed as the URL parameter</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "post",
    "url": "/api/v1/tasks/delete",
    "title": "Delete task coment by taskId and comment_id",
    "version": "0.0.1",
    "group": "delete",
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "title": "Get all tasks of the list",
    "version": "0.0.1",
    "group": "read",
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "title": "Edit subtask comment by comment_id",
    "version": "0.0.1",
    "group": "update",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "comment_id",
            "description": "<p>comment_id of the subrask passed as the URL parameter</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "put",
    "url": "/api/v1/blogs/:taskId/edit",
    "title": "Mark subtask done or undone",
    "version": "0.0.1",
    "group": "update",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "subTask_id",
            "description": "<p>subTask_id of the sub-task passed as the URL parameter</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "put",
    "url": "/api/v1/blogs/:taskId/edit",
    "title": "Edit task comment by commentId",
    "version": "0.0.1",
    "group": "update",
    "parameter": {
      "fields": {
